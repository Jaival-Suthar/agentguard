...
const prompt = [
  ...
  ...(sandboxEnabled
    ? [
        ...
        "The lookup response contains the complete synthetic diagnostic evidence for this demo; do not claim evidence that is absent from that response.",
        ...
        "The script must derive the root_cause_candidate only from validated diagnostic evidence in the lookup response.",
